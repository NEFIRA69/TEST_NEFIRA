...
Функционал: Создание документа Поступлений товаров

Как Менеджер по закупкам я хочу
Создание документа Поступлений товаров 
чтобы поставить товар на учет 
Контекст:
Дано Я открыл новый сеанс TestClient или подключил уже существующий

Сценарий: Создание документа Поступлений товаров
// создание
...
*Проверка таблицы
	Тогда таблица "Товары" содержит строки:
		...
		| 'Veko67NE' | '*'  | '7 000,00' | '12,00'      | '84 000,00' |
...
Сценарий: Проверка наличия справочника	
